...
exports.parseListTimelineUsers = exports.parseListTimelineTweets = void 0;
...
function parseListTimelineUsers(timeline) {
    let cursor;
    const profiles = [];
    const instructions = timeline.data?.list?.tweets_timeline?.timeline
        ?.instructions ?? [];
...
exports.parseListTimelineUsers = parseListTimelineUsers;
//# sourceMappingURL=timeline-search-list.js.map